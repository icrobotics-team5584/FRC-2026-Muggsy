...
class KrakenIO : public SwerveIO {
 ...
 private:
  ...
  frc::sim::DCMotorSim _turnMotorSim{frc::LinearSystemId::DCMotorSystem(frc::DCMotor::Falcon500(),
                                       0.000000001_kg_sq_m, TURNING_GEAR_RATIO),
    _turnMotorModel};

  frc::sim::DCMotorSim _driveMotorSim{
    frc::LinearSystemId::DCMotorSystem(
      frc::DCMotor::KrakenX60FOC(), 0.01_kg_sq_m, DRIVE_GEAR_RATIO),
    _driveMotorModel};
};
