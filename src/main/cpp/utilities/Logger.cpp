...
void Log(
  const std::string& keyName, ctre::phoenix6::StatusSignal<units::turns_per_second_t>& signal) {
  Log(keyName, signal.GetValue());
}
...
void Log(const std::string& keyName,
  ctre::phoenix6::StatusSignal<units::turns_per_second_squared_t>& signal) {
  Log(keyName, signal.GetValue());
}
...
units::turns_per_second_squared_t Tune(
  const std::string& keyName, units::turns_per_second_squared_t defaultValue) {
...
units::meters_per_second_t Tune(
  const std::string& keyName, units::meters_per_second_t defaultValue) {
  return units::meters_per_second_t(Tune(keyName + " (mps)", defaultValue.value()));
}

units::meters_per_second_squared_t Tune(
  const std::string& keyName, units::meters_per_second_squared_t defaultValue) {
