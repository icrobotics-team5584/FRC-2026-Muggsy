...
void NeoIO::ConfigTurnMotor() {
  ...
  _canTurnConfig.encoder.PositionConversionFactor(1.0 / TURNING_GEAR_RATIO)
  ...
  _canTurnConfig.Inverted(true).SetIdleMode(rev::spark::SparkBaseConfig::IdleMode::kBrake);
