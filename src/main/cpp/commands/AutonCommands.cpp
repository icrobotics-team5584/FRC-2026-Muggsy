...
frc2::CommandPtr TwoPassAuto(bool flip) {
  return frc2::cmd::Sequence(
    ...
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{6.629_m, 7.086_m, -60.0_deg}, flip), 1.2, 50_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{7.895_m, 6.658_m, -85.0_deg}, flip), 0.6, 40_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{8.113_m, 5.704_m, -80.0_deg}, flip), 0.4, 60_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
    ...
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{3.468_m, 5.570_m, -180.0_deg}, flip), 0.7, 30_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{2.392_m, 5.661_m, -215.0_deg}, flip), 0.4, 5_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
    ...
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{5.051_m, 7.530_m, -20.0_deg}, flip), 1.1, 50_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
    ...
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{7.948_m, 5.869_m, -75.0_deg}, flip), 0.8, 70_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{8.270_m, 4.935_m, -90.0_deg}, flip), 0.4, 60_cm, 15_deg), // 15
    SubDrivebase::GetInstance().DriveToPose(
    ...
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{6.099_m, 4.030_m, -180.0_deg}, flip), 0.3, 40_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{5.613_m, 4.034_m, -180.0_deg}, flip), 0.2, 30_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{5.808_m, 4.653_m, -180.0_deg}, flip), 0.4, 50_cm, 15_deg), // 20
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{5.788_m, 5.477_m, -180.0_deg}, flip), 0.6, 50_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{3.468_m, 5.570_m, -180.0_deg}, flip), 0.8, 80_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{2.392_m, 5.661_m, -215.0_deg}, flip), 0.4, 5_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{3.196_m, 7.131_m, -335.0_deg}, flip), 0.8, 40_cm, 15_deg),
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{3.801_m, 7.536_m, 0.0_deg}, flip), 1.2, 15_cm, 15_deg), // 25
    SubDrivebase::GetInstance().DriveToPose(
      icGeometry::MaybeFlip(frc::Pose2d{5.051_m, 7.530_m, -20.0_deg}, flip), 1.1, 50_cm, 15_deg)
